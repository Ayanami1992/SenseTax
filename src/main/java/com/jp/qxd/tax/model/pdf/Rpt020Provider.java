...
@Component
public class Rpt020Provider extends RptBaseProvider {
	private static Position ymdFrom = new Position(65, 622, MAINDATE, 10, 7, 0, 37);
	private static Position ymdTo = new Position(211, 622, MAINDATE, 10, 7, 0, 37);
	private static Position fixedYearFrom = new Position(33, 622, 10);
	private static Position fixedYearTo = new Position(179, 622, 10);
	//納税地
	...
	//経理責任者ふりがな
	private static Position accountingName_h = new Position(265, 666, 335, 656, 8);
	//経理責任者氏名
	private static Position accountingName = new Position(265, 654, 335, 644, 9);
	//代表者住所
...
//	private static Position a2 = new Position(495, 780, 565, 770, 11);
	...
	private static Position f_4 = new Position(413, 520, NUMBER, 10, 8, 0);
	private static Position f_5_1 = new Position(388, 500, NUMBER, 10, 8, 3);
	private static Position f_5_2 = new Position(427, 509, 452, 499, 10);
	private static Position f_5_3 = new Position(546, 500, NUMBER, 10, 8, 0);
	private static Position f_6_1 = new Position(388, 480, NUMBER, 10, 8, 3);
	private static Position f_6_2 = new Position(427, 489, 452, 479, 10);
	private static Position f_6_3 = new Position(546, 480, NUMBER, 10, 8, 0);
	private static Position f_7 = new Position(546, 460, NUMBER, 10, 8, 0);
	private static Position f_8 = new Position(546, 440, NUMBER, 10, 8, 0);
	private static Position f_9 = new Position(546, 420, NUMBER, 10, 8, 0);
	private static Position f_10 = new Position(546, 401, NUMBER, 10, 8, 0);
	private static Position f_11 = new Position(530, 382, NUMBER, 10, 8, 2);
	private static Position f_12 = new Position(530, 363, NUMBER, 10, 8, 2);
	private static Position f_13 = new Position(546, 342, NUMBER, 10, 8, 0);
	private static Position f_34 = new Position(530, 323, NUMBER, 10, 8, 2);
	private static Position f_14_1 = new Position(325, 313, 345, 303, 11);
	private static Position f_14_2 = new Position(370, 313, 413, 303, 11);
//	private static Position f_14_3 = new Position(441, 344, 445, 334, 9);
	private static Position f_15 = new Position(530, 302, NUMBER, 10, 8, 2);
	private static Position f_16 = new Position(530, 282, NUMBER, 10, 8, 2);
	private static Position f_17 = new Position(530, 263, NUMBER, 10, 8, 2);
	private static Position f_18 = new Position(530, 243, NUMBER, 10, 8, 2);
	private static Position f_19 = new Position(546, 224, NUMBER, 10, 8, 0);
	private static Position f_20 = new Position(546, 204, NUMBER, 10, 8, 0);
	private static Position f_21 = new Position(416, 136, NUMBER, 10, 8, 0);
	private static Position f_22 = new Position(481, 136, NUMBER, 10, 8, 0);
	private static Position f_23 = new Position(545, 136, NUMBER, 10, 8, 0);
	private static Position f_24_1 = new Position(30, 172, 140, 162, 9);
//	private static Position f_24_2 = new Position(200, 162, 410, 190, 9);
	private static Position f_24_2 = new Position(155, 162, 240, 152, PREFECTURES, 10, 1, 13);
	private static Position f_24_3 = new Position(481, 162, NUMBER, 10, 8, 0);
	private static Position f_24_4 = new Position(545, 162, NUMBER, 10, 8, 0);
	private static Position f_25_1 = new Position(30, 160, 140, 150, 9);
//	private static Position f_25_2 = new Position(200, 149, 410, 178, 9);
	private static Position f_25_2 = new Position(155, 150, 240, 140, PREFECTURES, 10, 1, 13);
	private static Position f_25_3 = new Position(481, 149, NUMBER, 10, 8, 0);
	private static Position f_25_4 = new Position(545, 149, NUMBER, 10, 8, 0);
...
//	private static Position f_36 = new Position(200, 790, 250, 700);
	...
	private static Position prefectures1 = new Position(175, 768, 390, 756, PREFECTURES, 12, 1, 13);
	private static Position prefectures2 = new Position(84, 189, 133, 179, PREFECTURES, 10, 0, 8);
	private static Position prefectures3 = new Position(489, 191, 522, 184, PREFECTURES, 7, 0, 4);
